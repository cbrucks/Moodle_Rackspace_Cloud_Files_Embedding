...
$string['invalid_api_key'] = 'Invalid API Key!<br />Only hex values are acceptable (0-9 a-f A-F).';
 ...
 *
 */
$string['repo_auth_fail'] = 'Rackspace Cloud Files Repository authentication failure.';
