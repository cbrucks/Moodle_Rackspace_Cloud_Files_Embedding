...
$string['instructions'] = 'You can get your API Key from <a href="http://mycloud.rackspace.com">Rackspace Cloud Control Panel</a>.<br />Expand the drop-down menu at the top right where your username is.  Click "API Keys" and finally click "Show Key"';
