...
class repository_rackspace_cloud_files extends repository {
	...
	public static function type_config_form($mform, $classname = 'repository') {
        ...
        $mform->addElement('static', 'instructions', get_string('instructions_label','repository_rackspace_cloud_files'), get_string('instructions', 'repository_rackspace_cloud_files'));
